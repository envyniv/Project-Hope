...
class_name ScrollingBackground, "res://scenes/icons/plugin.png"

# ------------------------------------
# Scrolling Background
# A scrolling tiled background
# by Dennis Plöger, edited by envyniv
# ------------------------------------
...
export(float) var speed_x setget set_speed_x, get_speed_x
export(float) var speed_y setget set_speed_y, get_speed_y
export(float) var scale setget set_scale, get_scale
export(float) var modulate setget set_modulate, get_modulate
