extends Node
# TODO: dehardcode?
onready var voice_select  = $Popup/ScrollContainer/VBoxContainer/VoiceBloop
onready var language      = $Popup/ScrollContainer/VBoxContainer/Language
onready var music         = $Popup/ScrollContainer/VBoxContainer/Music
onready var sfx           = $Popup/ScrollContainer/VBoxContainer/SFX
onready var muslabel      = $Popup/ScrollContainer/VBoxContainer/Music/Percentage
onready var sfxlabel      = $Popup/ScrollContainer/VBoxContainer/SFX/Percentage
onready var modman        = $Popup/ScrollContainer/VBoxContainer/Modman
onready var scale         = $Popup/ScrollContainer/VBoxContainer/Scale
onready var controls      = $Popup/ScrollContainer/VBoxContainer/Controls
onready var txtspd        = $Popup/ScrollContainer/VBoxContainer/TextSpd
onready var txtspdlabel   = $Popup/ScrollContainer/VBoxContainer/TextSpd/Percentage
