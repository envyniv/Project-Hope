...
const sounds = {
    'a': preload('res://Sounds/Male/1/a.wav'),
    'b': preload('res://Sounds/Male/1/b.wav'),
    'c': preload('res://Sounds/Male/1/c.wav'),
    'd': preload('res://Sounds/Male/1/d.wav'),
    'e': preload('res://Sounds/Male/1/e.wav'),
    'f': preload('res://Sounds/Male/1/f.wav'),
    'g': preload('res://Sounds/Male/1/g.wav'),
    'h': preload('res://Sounds/Male/1/h.wav'),
    'i': preload('res://Sounds/Male/1/i.wav'),
    'j': preload('res://Sounds/Male/1/j.wav'),
    'k': preload('res://Sounds/Male/1/k.wav'),
    'l': preload('res://Sounds/Male/1/l.wav'),
    'm': preload('res://Sounds/Male/1/m.wav'),
    'n': preload('res://Sounds/Male/1/n.wav'),
    'o': preload('res://Sounds/Male/1/o.wav'),
    'p': preload('res://Sounds/Male/1/p.wav'),
    'q': preload('res://Sounds/Male/1/q.wav'),
    'r': preload('res://Sounds/Male/1/r.wav'),
    's': preload('res://Sounds/Male/1/s.wav'),
    't': preload('res://Sounds/Male/1/t.wav'),
    'u': preload('res://Sounds/Male/1/u.wav'),
    'v': preload('res://Sounds/Male/1/v.wav'),
    'w': preload('res://Sounds/Male/1/w.wav'),
    'x': preload('res://Sounds/Male/1/x.wav'),
    'y': preload('res://Sounds/Male/1/y.wav'),
    'z': preload('res://Sounds/Male/1/z.wav'),
    'th': preload('res://Sounds/Male/1/th.wav'),
    'sh': preload('res://Sounds/Male/1/sh.wav'),
    ' ': preload('res://Sounds/Misc/blank.wav'),
    '.': preload('res://Sounds/Misc/longblank.wav')
}
